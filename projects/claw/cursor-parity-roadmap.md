## CLAW — Cursor Parity And Sovereign Memory Roadmap

This document maps Cursor-style UX/features onto CLAW's current architecture
...
CLAW already has the right backend shape:
...
CLAW already differentiates here:
...
Once the first RTX 3090 arrives, CLAW's biggest advantage is not just
