...
materials. The primary use case is the "boardroom scenario" — Toby asks Cairn a
question while with a client, and Cairn searches semantically across all CRM data
...
- AI: Migrating from Llama to Cairn hybrid search
...
- **Context endpoint:** Integrated via Cairn's web stream proxy (CRM semantic search)

## Current Status
- Build phase: Live at crm.nbnesigns.co.uk
- Last significant change: Registered as Cairn project (2026-04-04)
...
## Key Concepts
- **Boardroom scenario:** Toby queries Cairn during a client meeting for instant access to relevant history
