...
### Deek — Sovereign AI Development System
...
When all three module context endpoints are live, Deek assembles them into a
...
2. Fix git_commit tool mapping in Deek (resolves to git_add — see DEEK_PROTOCOL.md)
...
- `DEEK_PROTOCOL.md` — full developer protocol, project registry, memory system
- `projects/phloe/core.md` — Phloe domain context and decision log
- `projects/deek/core.md` — Deek's own decision log

---

## The Principle

Deek gets more useful the more it is used. Every session that writes back makes
