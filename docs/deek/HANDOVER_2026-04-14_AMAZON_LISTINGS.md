...
| Docs | `docs/deek/amazon_notifications_setup.md`, `docs/deek/amazon_consumers.md` |
...
**Deek API:** `deploy-deek-api-1` on Hetzner `178.104.1.152:8765`, commit `8f3b14d` or later
**Database:** 16 `ami_*` tables in Deek PostgreSQL
...
Env vars in `/opt/nbne/deek/deploy/.env` on Hetzner.
