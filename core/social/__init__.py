"""
Deek Social — drafting + proof-reading assistant for Jo at NBNE.

Phase 1 scope (per DEEK_SOCIAL_V2_HANDOFF.md + Toby 2026-04-10):
  ...
  - Single user (Jo hard-coded; Deek is API-key-only at present)
